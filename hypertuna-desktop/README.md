...
![Hypertuna icon](./public/pwa-512x512.png)

Hypertuna Desktop is the Electron renderer and shell for the Hypertuna peer-to-peer relay client. It runs alongside the shared worker in [`../hypertuna-worker`](../hypertuna-worker) and consumes shared protocol/UI code from [`../shared`](../shared).
