      ...
      <div className="px-6 pt-6 pb-8 max-w-3xl mx-auto space-y-6">
        ...
        <div className="space-y-4 text-base">
          ...
          <p>
            ...
            for portable identity, relay-based discovery, and interoperable event flows. Hypertuna
          ...
          <p>
            ...
            identity model, event format, and relay architecture that Hypertuna extends for
